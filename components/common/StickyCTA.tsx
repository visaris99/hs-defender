      ...
      {isVisible && (
        ...
        >
          <div className="max-w-lg mx-auto">
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 shadow-xl rounded-2xl p-4 flex items-center gap-4">
              {/* Message */}
              <div className="flex-1 pl-2">
                <p className="text-sm font-semibold text-slate-100">궁금한 점이 있으신가요?</p>
                <p className="text-xs text-slate-400 leading-relaxed">지금 바로 상담받아보세요</p>
              </div>

              {/* Kakao Button */}
              <button
                onClick={handleKakaoClick}
                className="flex items-center gap-2 bg-[#FEE500] text-[#3C1E1E] font-bold px-5 py-3 rounded-xl hover:bg-[#FDD835] transition-all text-sm whitespace-nowrap shadow-lg"
              >
